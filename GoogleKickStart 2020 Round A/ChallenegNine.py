# Problem
# Ada gives John a positive integer N. She challenges him to construct a new number (without leading zeros), that is a multiple of 9, by inserting exactly
# one digit (0 … 9) anywhere in the given number N. It is guaranteed that N does not have any leading zeros.
...
# Output
# For each test case, output one line containing Case #x: y, where x is the test case number (starting from 1) and y is the new number constructed
# by John. As mentioned earlier, y cannot have leading zeros.
# Limits
# Memory limit: 1 GB.
# 1≤T≤100.
# Test Set 1
